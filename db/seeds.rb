...
change_request = ChangeRequest.new(user: user_requester, entity_source: 'engineering', change_summary: 'Change Summary 1')
...
change_request_with_approval = ChangeRequest.new(user: user_requester, entity_source: 'engineering', change_summary: 'Change Summary 2')
